...
func init() {
	sqlStmt["generic:get_feed"] = get_feed
	sqlStmt["generic:create_feed"] = create_feed
	sqlStmt["generic:update_feed"] = update_feed
	sqlStmt["generic:delete_feed"] = delete_feed
	sqlStmt["generic:get_feeds"] = get_feeds
	sqlStmt["generic:get_feed_by_link"] = get_feed_by_link
	sqlStmt["generic:get_unsubscribed_feeds"] = get_unsubscribed_feeds
	sqlStmt["generic:get_user_feed"] = get_user_feed
	sqlStmt["generic:create_user_feed"] = create_user_feed
	sqlStmt["generic:delete_user_feed"] = delete_user_feed
	sqlStmt["generic:get_user_feeds"] = get_user_feeds
	sqlStmt["generic:create_feed_article"] = create_feed_article
	sqlStmt["generic:update_feed_article"] = update_feed_article
	sqlStmt["generic:update_feed_article_with_guid"] = update_feed_article_with_guid
	sqlStmt["generic:get_article_columns"] = get_article_columns
	sqlStmt["generic:get_article_tables"] = get_article_tables
	sqlStmt["generic:get_article_joins"] = get_article_joins
	sqlStmt["generic:get_user_article_count"] = get_user_article_count
	sqlStmt["generic:get_all_articles"] = get_all_articles
	sqlStmt["generic:get_all_feed_articles"] = get_all_feed_articles
	sqlStmt["generic:get_all_unread_user_article_ids"] = get_all_unread_user_article_ids
	sqlStmt["generic:create_user_article_read"] = create_user_article_read
	sqlStmt["generic:create_user_article_favorite"] = create_user_article_favorite
	sqlStmt["generic:get_all_favorite_user_article_ids"] = get_all_favorite_user_article_ids
	sqlStmt["generic:create_all_user_articles_read_by_date"] = create_all_user_articles_read_by_date
	sqlStmt["generic:delete_all_user_articles_read_by_date"] = delete_all_user_articles_read_by_date
	sqlStmt["generic:delete_newer_user_articles_read_by_date"] = delete_newer_user_articles_read_by_date
	sqlStmt["generic:create_all_users_articles_read_by_feed_date"] = create_all_users_articles_read_by_feed_date
	sqlStmt["generic:delete_all_users_articles_read_by_feed_date"] = delete_all_users_articles_read_by_feed_date
}
