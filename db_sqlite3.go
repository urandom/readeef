...
func init() {
	initSql["sqlite3"] = init_sql_sqlite3
	upgradeFunc["sqlite3"] = sqlite3Upgrade
	sqlStmt["sqlite3:get_user_feeds"] = sqlite3_get_user_feeds
	sqlStmt["sqlite3:get_user_tag_feeds"] = sqlite3_get_user_tag_feeds
	sqlStmt["sqlite3:get_latest_feed_articles"] = sqlite3_get_latest_feed_articles
}
